...
- [x] **Fix race condition in TestBridgeNode_FrequencyCycling** (Priority: CRITICAL)
  ...
  - **Status**: FIXED - Added `bridgeFreqsMu sync.RWMutex` field and protected all reads/writes
